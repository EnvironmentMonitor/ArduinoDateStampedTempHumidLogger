...
!*!*!*! Please note the 6 Libraries Required in the Includes.......!*!*!*!|
---------------------------------------------------------------------------
*/
#include <Wire.h>
#include "RTClib.h"
...
void setup(void) {
    Serial.begin(9600);
 Serial.println("DS18B20 Digital Temperature Plus DHT22 Hunidity Logging Starting....");
 ...
 delay(2000);
  ...
  File dataFile = SD.open("datalog.CSV", FILE_WRITE);
    if (dataFile) {
      ...
      dataFile.print(",D5,");
      dataFile.print(sensors.getTempCByIndex(4));
      dataFile.print(",D6,");
      dataFile.print(sensors.getTempCByIndex(5));
      dataFile.print(",DH1H,");
      dataFile.print(h);
      dataFile.print(",DH1T,");      
      dataFile.print(t);
  ...
  show_temperature(sensors.getTempCByIndex(4));
  show_temperature(sensors.getTempCByIndex(5)); 
  delay(1000);
}
